# 
# Project automation script for Procesador 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Procesador.tcl), then you can
...
set myProject "Procesador"
set myScript "Procesador.tcl"
...
proc add_source_files {} {
   ...
   xfile add "Semi_Procesador_64.v"

   # Set the Top Module as well...
   project set top "Semi_Procesador_64"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "C:/Users/Ghost/Desktop/Procesador/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "Semi_Procesador_64" -process "Generate IBIS Model"
